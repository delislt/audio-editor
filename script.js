...
(function () {
  ...
  const FACTORY_PRESETS = {
    ...
    clubbathroom: factoryPreset({ label: 'Club Bathroom', category: 'space', icon: 'door-open', description: 'Muffled club bass on reflective tile', colors: ['#06b6d4', '#f43f5e'] }, { gainDb: -7, bass: 6, mid: -3, treble: -7, reverb: 46, echo: 4, stereoWidth: 112, lowPassEnabled: true, lowPassFrequency: 4800, compressorEnabled: true, compressorThreshold: -20, compressorRatio: 3, advancedEq: presetEq([{ enabled: true, frequency: 90, gain: 3 }, { enabled: true, frequency: 260, gain: -1 }, { enabled: true, frequency: 1200, gain: -2 }, { enabled: true, frequency: 3200, gain: -3 }, { enabled: true, frequency: 9000, gain: -5 }]) }),
